...
class ManageDocTor extends Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        ...
        if (prevProps.allRequiredDoctorInfor !== this.props.allRequiredDoctorInfor) {
            // console.log('Huynh check get data from redux: ', this.props.allRequiredDoctorInfor)
            ...
            // console.log('Huynh check data select: ', dataSelectPrice, dataSelectPayment, dataSelectProvince);
            this.setState({
                listPrice: dataSelectPrice,
                listPayment: dataSelectPayment,
                listProvince: dataSelectProvince,
    ...
    handleChangeSelect = async (selectedDoctor) => {
        this.setState({ selectedDoctor });//listSpecialty : lấy trong bảng getallrequire
        ...
        if (res && res.data && res.data.Markdown) {
            ...
            let addressClinic = '', nameClinic = '', note = '',
                priceId = '', provinceId = '', paymentId = '', specialtyId = '', clinicId = '',
    ...
    handleOnChangeText = (event, id) => {
        ...
        // console.log('Huynh check value description: ', this.state.description)
    }
    ...
    render() {
        ...
        let { hasOldata } = this.state;
        // console.log('Huynh check value state: ', this.state.selectedDoctor)
        return (
            <div className='manage-doctor-container'>
                ...
                <div className='more-infor'>
                    <div className='content-left'>
                        <label>
                            <FormattedMessage id="admin.manage-doctor.select-doctors"></FormattedMessage>
                        </label>
                        ...
                        <Select
                            ...
                            placeholder={<FormattedMessage id="admin.manage-doctor.select-doctors" />}
                        />
...
const mapStateToProps = state => {
    return {
        ...
        allRequiredDoctorInfor: state.admin1.allRequiredDoctorInfor,
    };
};
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        saveDetailDoctorRedux: (data) => dispatch(actions.saveDetailInforDoctor(data))
    };
};
